...
def calcular_estadisticas(datos):
    ...
    # 2. Total de ejemplares y promedio del valor de adquisición
    ...
    # 5. Promedio de multas (solo préstamos con multa mayor a 0)
    ...
    # 6. Porcentaje de libros orientados a las carreras del proyecto
    carreras_objetivo = {
    ...
    # 7. Carrera/género con más libros asociados
